...
//    private static final String modelName = "用户管理";   // 必填
    ...
    private static final String BaseFilePath =
            "D:\\KingPoint\\Test\\src\\main\\java\\com\\ambrose";
    private static final String basePackageName = "com.ambrose";
...
//            createVueHtml(entityName, table[0]);
    ...
    static void createEntity(String tableName, String entityName) throws SQLException {
        ...
        StringBuilder entityHeadBuild = StrUtil.builder()
                .append("package ").append(basePackageName).append(".domain;\n\n")
        ...
        StringBuilder entityBodyBuild = StrUtil.builder()
                ...
                .append(space4).append("private ").append(columnList.get(0).getDataType()).append( " id;\n\n");
        ...
        FileUtil.writeString(entityHeadBuild.append(entityBodyBuild).toString(), BaseFilePath + "/domain/" + entityName + ".java", "UTF-8");
        System.out.println(entityName + "domain生成成功！");
    }
    ...
    static void createMapper(String entityName) {
        StringBuilder build = StrUtil.builder().append("package ").append(basePackageName).append(".mapper;\n\n")
                .append("import ").append(basePackageName).append(".domain.").append(entityName).append(";\n")
    ...
    static void createService(String entityName) {
        ...
        StringBuilder build = StrUtil.builder().append("package ").append(basePackageName).append(".service;\n\n")
                .append("import ").append(basePackageName).append(".domain.").append(entityName).append(";\n")
                .append("import com.baomidou.mybatisplus.extension.service.IService;\n\n")
                .append("public interface ").append(entityName).append("Service extends IService<")
     ...
     * 生成serviceImpl
     */
    static void createServiceImpl(String entityName) {
        String lowerName = entityName.substring(0, 1).toLowerCase() + entityName.substring(1);
        String mapperUpperName = entityName + "Mapper";
        String mapperLowerName = lowerName + "Mapper";
        StringBuilder build = StrUtil.builder().append("package ").append(basePackageName).append(".service.impl;\n\n")
                .append("import ").append(basePackageName).append(".domain.").append(entityName).append(";\n")
                .append("import ").append(basePackageName).append(".mapper.").append(entityName).append("Mapper;\n")
                .append("import ").append(basePackageName).append(".service.").append(entityName).append("Service;\n")
                .append("import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;\n")
                .append("import org.springframework.stereotype.Service;\n\n")

                .append("@Service\n")
                .append("public class ").append(entityName).append("ServiceImpl extends ServiceImpl<")
                .append(mapperUpperName).append(", ").append(entityName).append("> ")
...
//                .append(space4).append("private ").append(mapperUpperName).append(" ").append(mapperLowerName).append(";\n\n")
                .append("}");
        FileUtil.writeString(build.toString(), BaseFilePath + "/service/impl/" + entityName + "ServiceImpl" + ".java", "UTF-8");
        System.out.println(entityName + "Service生成成功！");
    }
    ...
    static void createController(String entityName) {
        ...
        StringBuilder build = StrUtil.builder().append("package ").append(basePackageName).append(".controller;\n\n")
//                .append("import").append(basePackageName).append(".common.Result;\n ")
                .append("import ").append(basePackageName).append(".domain.").append(entityName).append(";\n")
                .append("import ").append(basePackageName).append(".service.").append(serviceUpperName).append(";\n")
